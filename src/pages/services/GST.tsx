...
// Import images
import heroImage from "@/assets/services/gst.jpg";
import gstProcessImage from "@/assets/services/gst-process.jpg";
import consultationImage from "@/assets/services/consultation.jpg";
import teamImage from "@/assets/services/team-working.jpg";

const GSTService = () => {
  const service = getServiceBySlug("gst");
  const content = getServiceContent("gst");
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                ...
                <span className="text-sm font-medium">GST Services</span>
              </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  ...
                  <p className="text-primary-foreground/80">Returns Filed</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  ...
                  <p className="text-primary-foreground/80">Days Registration</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
                  <div className="text-4xl font-bold text-accent mb-2">24/7</div>
                  <p className="text-primary-foreground/80">Expert Support</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              Complete range of GST services for businesses of all sizes
            </motion.p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              { return: "GSTR-1", due: "11th", desc: "Outward supplies", freq: "Monthly" },
              { return: "GSTR-3B", due: "20th", desc: "Summary return with tax payment", freq: "Monthly" },
              { return: "GSTR-9", due: "Dec 31", desc: "Annual return", freq: "Yearly" },
              { return: "GSTR-9C", due: "Dec 31", desc: "Reconciliation statement", freq: "Yearly" }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-foreground mb-2">{item.return}</h3>
                <p className="text-accent font-semibold mb-2">Due: {item.due}</p>
                <p className="text-sm text-muted-foreground mb-1">{item.desc}</p>
                <span className="inline-flex px-2 py-1 text-xs rounded-full bg-success/10 text-success">{item.freq}</span>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                Why Choose CA India for GST Services?
              </motion.h2>
      ...
      <section className="py-20 bg-gradient-accent text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Whether you need registration, return filing, or notice handling, our GST experts are here to help.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
